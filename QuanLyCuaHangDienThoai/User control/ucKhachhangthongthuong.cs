...
{
    public partial class ucKhachhangthongthuong : UserControl
    {
        public ucKhachhangthongthuong()
        {
            InitializeComponent();
        }
        ...
        private void ucKhachhangthongthuong_Load(object sender, EventArgs e)
        {
            bdsDanhsachkhachhang.DataSource = Model.GetKHthonghthuongItems();
        }
